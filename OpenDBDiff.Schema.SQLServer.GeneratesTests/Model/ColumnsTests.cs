...
namespace OpenDBDiff.Schema.SQLServer.Generates.Model.Tests
{
    ...
    public class CompareColumnsTests
    {
        ...
        [TestMethod()]
        public void OriginHasSameCollation_ShouldBeEmptyScript()
        {
            int idStorage = 1;
            System.Func<int> getId = new Func<int>(() => ++idStorage);
            Database originDatabase = new Database();
            ...
            var originColumn2 = new Column(originTable)
            {
                ...
                Type = "varchar(20)",
                Id = getId(),
                Collation = originDatabase.Info.Collation
            };
            originTable.Columns.Add(originColumn1);
            originTable.Columns.Add(originColumn2);
            originDatabase.Tables.Add(originTable);
            ...
            var destinationColumn2 = new Column(destinationTable)
            {
                Name = "Test2",
                Type = "varchar(20)",
                Id = getId(),
                Collation = destinationDatabase.Info.Collation
            };
            destinationTable.Columns.Add(destinationColumn1);
            destinationTable.Columns.Add(destinationColumn2);
            destinationDatabase.Tables.Add(destinationTable);
        ...
        [TestMethod()]
        public void OriginHasDifferentCollation_ShouldBeAlterColumnScript()
        {
            int idStorage = 1;
            System.Func<int> getId = new Func<int>(() => ++idStorage);
            Database originDatabase = new Database();
            ...
            SQLScriptList sqlList = originTable.ToSqlDiff(new List<ISchemaBase>() { destinationColumn2 });
            string sql = sqlList.ToSQL();
            Assert.AreEqual($@"ALTER TABLE [{originTable.Name}] ALTER COLUMN [{originColumn2.Name}] [varchar(20)] COLLATE {destinationColumn2.Collation} NOT NULL
GO
", sql);
        }
    }
